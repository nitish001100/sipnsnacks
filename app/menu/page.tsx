        ...
        <>
          ...
          <div className="fixed z-[80] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#1B2E3C] border border-green-500/30 rounded-2xl shadow-2xl p-8 w-[90%] max-w-sm text-center">
            ...
            <p className="text-white/50 text-sm mb-4">
              Your order has been received and sent to our team!
            </p>
            <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-3 mb-4 text-left">
              <p className="text-green-400 text-xs font-medium mb-1">📱 What happens next?</p>
              <p className="text-white/60 text-xs">We&apos;ll contact you on your WhatsApp number to confirm delivery time. Sit back and relax! 😊</p>
            </div>
            <button
